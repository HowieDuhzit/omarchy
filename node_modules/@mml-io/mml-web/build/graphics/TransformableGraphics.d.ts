...
export declare abstract class TransformableGraphics<G extends GraphicsAdapter = GraphicsAdapter> {
    ...
    abstract setSocket(socket: string | null, transformableElementProps: TransformableElementProps): void;
    ...
    abstract setRotationX(rotationX: number, transformableElementProps: TransformableElementProps): void;
    abstract setRotationY(rotationY: number, transformableElementProps: TransformableElementProps): void;
    abstract setRotationZ(rotationZ: number, transformableElementProps: TransformableElementProps): void;
...
//# sourceMappingURL=TransformableGraphics.d.ts.map