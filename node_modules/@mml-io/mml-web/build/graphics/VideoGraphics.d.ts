...
export declare abstract class VideoGraphics<G extends GraphicsAdapter = GraphicsAdapter> {
    constructor(element: Video<G>, updateMeshCallback: () => void);
    abstract enable(): void;
    abstract disable(): void;
    abstract getCollisionElement(): G["collisionType"] | null;
    abstract getWidthAndHeight(): {
        width: number;
        height: number;
    };
...
//# sourceMappingURL=VideoGraphics.d.ts.map