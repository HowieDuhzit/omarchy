...
export declare class Video<G extends GraphicsAdapter = GraphicsAdapter> extends TransformableElement<G> {
    static tagName: string;
    private videoAnimatedAttributeHelper;
    static get observedAttributes(): Array<string>;
    private documentTimeListener;
    private collideableHelper;
